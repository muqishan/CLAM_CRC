...
parser.add_argument('--config_file', type=str, default="config_colon_ctrans.yaml")
...
if __name__ == '__main__':
    ...
    if data_args.process_list is None:
        ...
        print('dataframe_dataframe_dataframe_dataframe_dataframe_dataframe_dataframe_:',df)
    ...
    print('reverse_label_dictreverse_label_dictreverse_label_dictreverse_label_dict:',reverse_label_dict)
    ...
    for i in tqdm(range(len(process_stack))):
        ...
        Y_hats, Y_hats_str, Y_probs, A = infer_single_slide(model, features, label, reverse_label_dict, exp_args.n_classes) # A 注意力分数
        del features
