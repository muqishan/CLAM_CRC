...
parser.add_argument('--feature_dir', type=str, default=None, 
                    help='feature_dir directory')

parser.add_argument('--csv_path', type=str, default=None, help='csv_path')
...
parser.add_argument('--results_dir', default='./result20240913', help='results directory (default: ./results)')
...
parser.add_argument('--early_stopping', action='store_true', default=20, help='enable early stopping')
...
parser.add_argument('--model_size', type=str, choices=['small', 'big','bigbig'], default='small', help='size of model, does not affect mil')
...
os.path.exists(args.results_dir) or os.makedirs(args.results_dir)
...
if args.task == 'task_1_tumor_vs_normal':
    ...
    dataset = Generic_MIL_Dataset(csv_path = 'RESULTS_DIRECTORY/A1/filter100labels.csv',
                            data_dir= os.path.join(args.data_root_dir, 'RESULTS_DIRECTORY/A1'),
                            shuffle = False, 
                            seed = args.seed, 
                            print_info = True,
